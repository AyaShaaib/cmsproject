<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddAlbum.aspx.cs" Inherits="Annex.UserControl.Template.Albums.AddAlbum" %>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <asp:TextBox runat="server" ID="AlbumOrder" CssClass="form-control" TextMode="Number"></asp:TextBox>
                                    </div>
                                </div>
                                <br />
                                <div class="form-group row">
