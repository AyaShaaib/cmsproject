<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditProductType.aspx.cs" Inherits="Annex.UserControl.Template.ProductType.EditProductType" %>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="form-group row col-2">
                                    <asp:Button ID="btnEdit" runat="server" Text="Edit" class="btn-primary" OnClick="Edit_Click" CssClass="btn-primary form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
