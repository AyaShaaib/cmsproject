<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InsertProduct.aspx.cs" Inherits="Annex.UserControl.Template.Products.InsertProduct" ValidateRequest="false"%>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="form-group row col-2">
                                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btn-primary" OnClick="Insert_Click" CssClass="btn-primary form-control"/>
                                </div>
                            </div>
                        </div>
                    </div>
